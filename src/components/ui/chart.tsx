...
interface ChartTooltipProps extends React.ComponentPropsWithoutRef<typeof RechartsPrimitive.Tooltip> {}

const ChartTooltip = RechartsPrimitive.Tooltip as React.FC<ChartTooltipProps>;

interface ChartTooltipContentProps extends React.ComponentPropsWithoutRef<typeof RechartsPrimitive.Tooltip> {
  ...
  formatter?: (value: string | number, name: string, item: any, index: number, payload: any) => React.ReactNode;
  color?: string;
  nameKey?: string;
  labelKey?: string;
}
...
interface ChartLegendProps extends React.ComponentPropsWithoutRef<typeof RechartsPrimitive.Legend> {}

const ChartLegend = RechartsPrimitive.Legend as React.FC<ChartLegendProps>;
